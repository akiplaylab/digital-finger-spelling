...
The app now reads each hand shape from a sprite sheet (`assets/img/hand-sprite.png`).
...
If you want to use your own artwork, replace `assets/img/hand-sprite.png` with your sprite sheet while keeping the same 8x4 layout (32 cells in total).
